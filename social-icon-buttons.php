...
function add_social_icons($content)
{
	...
	<div class="social-icons">
		...
		<a href="https://plus.google.com/share?url=' . $urlCurrentPage . '" class="google-plus" target="_blank" rel="noopener" title="' . esc_html__('Google+', 'social-icon-buttons') . '"><i class="social fa fa-google-plus" aria-hidden="true"></i><span>' . esc_html__('Share using Google+', 'social-icon-buttons') . '</span></a>
