...
if ( ! empty( $facebook ) )
echo '<a href="https://facebook.com/' . $facebook . '" class="facebook" target="_blank" title="Facebook"><i class="social fa fa-facebook" aria-hidden="true"></i></a>';

$twitter = $instance['twitter'];
if ( ! empty( $twitter ) )
echo '<a href="https://twitter.com/' . $twitter . '" class="twitter" target="_blank" title="Twitter"><i class="social fa fa-twitter" aria-hidden="true"></i></a>';

$googleplus = $instance['googleplus'];
if ( ! empty( $googleplus ) )
echo '<a href="https://plus.google.com/' . $googleplus . '" class="google-plus" target="_blank" title="Google+"><i class="social fa fa-google-plus" aria-hidden="true"></i></a>';

$pinterest = $instance['pinterest'];
if ( ! empty( $pinterest ) )
echo '<a href="https://pinterest.com/' . $pinterest . '" class="pinterest" target="_blank" title="Pinterest"><i class="social fa fa-pinterest-p" aria-hidden="true"></i></a>';

$feedly = $instance['feedly'];
if ( ! empty( $googleplus ) )
echo '<a href="' . $feedly . '" class="feedly" target="_blank" title="Feedly"><i class="social fa fa-rss" aria-hidden="true"></i></a>';

$email = $instance['email'];
if ( ! empty( $email ) )
echo '<a href="mailto:' . $email . '" class="email" target="_blank" title="Email"><i class="social fa fa-envelope" aria-hidden="true"></i></a>';

$print = $instance['print'];
if ( ! empty( $print ) )
echo '<a href="#" onclick="window.print()" class="print" target="_blank"><i class="social fa fa-print" aria-hidden="true" title="Print"></i></a>';
